package com.unshoo.pixelmusic.data.network.qqmusic
...
class QqMusicApiService @Inject constructor(
    ...
    private val okHttpClient: OkHttpClient = baseOkHttpClient.newBuilder()
        ...
        .addInterceptor(com.unshoo.pixelmusic.data.remote.qqmusic.QQMusicEncryptInterceptor(
            com.unshoo.pixelmusic.data.remote.qqmusic.QQSignGenerator(context)
        ))
